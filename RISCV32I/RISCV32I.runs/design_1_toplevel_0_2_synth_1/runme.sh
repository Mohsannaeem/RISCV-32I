...
HD_PWD='D:/VDesign/RISCV32I/RISCV32I.runs/design_1_toplevel_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_toplevel_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_toplevel_0_2.tcl
