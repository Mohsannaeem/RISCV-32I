...
#Clock signal
#set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS18 } [get_ports { clk }]; #IO_L11P_T1_SRCC_35 Sch=sysclk
#create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { clk }];

		
##Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS18 } [get_ports { reset_n }]; #IO_L19N_T3_VREF_35 Sch=SW0
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS18 } [get_ports { gpio_pins[5] }];  #IO_L24P_T3_34 Sch=SW1
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS18 } [get_ports { gpio_pins[6]}]; #IO_L4N_T0_34 Sch=SW2
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS18 } [get_ports { gpio_pins[7] }]; #IO_L9P_T1_DQS_34 Sch=SW3


##Buttons
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS18 } [get_ports { gpio_pins[0] }]; #IO_L20N_T3_34 Sch=BTN0
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS18 } [get_ports { gpio_pins[1] }]; #IO_L24N_T3_34 Sch=BTN1
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS18 } [get_ports { gpio_pins[2] }]; #IO_L18P_T2_34 Sch=BTN2
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS18 } [get_ports { gpio_pins[3] }]; #IO_L7P_T1_34 Sch=BTN3


##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS18 } [get_ports { gpio_pins[8] }]; #IO_L23P_T3_35 Sch=LED0
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS18 } [get_ports { gpio_pins[9]}]; #IO_L23N_T3_35 Sch=LED1
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS18 } [get_ports { gpio_pins[10] }]; #IO_0_35=Sch=LED2
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS18 } [get_ports { gpio_pins[11] }]; #IO_L3N_T0_DQS_AD1N_35 Sch=LED3
...
#set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS18 } [get_ports { uart1_rxd }]; #IO_L21N_T3_DQS_AD14N_35 Sch=JA1_R_N
#set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS18 } [get_ports { uart1_txd }]; #IO_L22N_T3_AD7N_35 Sch=JA2_R_N
...
#set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS18 } [get_ports { uart0_rxd }]; #IO_L17N_T2_34 Sch=JB3_N
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS18 } [get_ports { gpio_pins[4] }]; #IO_L22P_T3_34 Sch=JB4_P
