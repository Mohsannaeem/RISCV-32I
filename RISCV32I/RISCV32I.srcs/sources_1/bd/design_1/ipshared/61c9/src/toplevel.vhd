...
begin
	...
	clkgen: entity work.clock_generator
		...
		process(clk) begin 
		processor_data_out_o<=processor_dat_out;
        processor_adr_out_o <= processor_adr_out ;
        processor_sel_out_o <= processor_sel_out ;
        processor_cyc_out_o <= processor_cyc_out ;
        processor_stb_out_o <= processor_stb_out ;
        processor_we_out_o  <= processor_we_out  ;
        processor_dat_in_o  <= processor_dat_in  ;
        processor_ack_in_o  <= processor_ack_in  ;
		end process;
